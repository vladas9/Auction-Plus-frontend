...
## v0.5.1 - Code Refactoring (Date: 2024-11-22)

### Reason
- As soon as project grows in it's codebase, frontend team decided to migrate the project to feature-driven structure.
This would emphasize a better project handling, ensuring that all future improovements will be easy to integrate.
- Migrating the project gives us the opportunity to rewrite the components following SOLID principles

### Modification
- **Profile Page refactoring**:
  - All logical sections of the program are written in custom hooks. All component related to this page are in correspondig folder 
- **Lot page refactoring**:
  - All logical sections of the program are written in custom hooks. All component related to this page are in correspondig folder 
